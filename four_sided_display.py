...
def create_side_display(month, day, event_data, side_number):
    ...
    draw_centered_text(draw, event_text, text_block_top + text_block_height//2, width, font_small)
...
def generate_for_date(month, day):
    ...
    for i, event in enumerate(selected_events):
        ...
        img = create_side_display(month, day, event, side_num)
